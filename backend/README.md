...
## Project Structure
    ...
    ├── testapiautosetting_118352  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_118352`
...
2. Clone this repo and `cd testapiautosetting_118352`
